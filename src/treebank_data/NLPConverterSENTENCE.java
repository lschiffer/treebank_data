...
public class NLPConverterSENTENCE extends DefaultHandler{
			...
			throws SAXException
	{
		...
		boolean insert = true;
		try {
			PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("outputSENTENCE.txt", true)));
	...
	public static void main(String[] args){
		...
		try{
			...
			File f = new File("outputSENTENCE.txt");
			f.delete();
	...
	/*		FileReader fr2 = new FileReader("v2.0/Latin/perseus-lattb.1248.1.xml");
		...
		/*	InputSource is3 = new InputSource(fr3);
			...
			NLPConverterSENTENCE converter = new NLPConverterSENTENCE();
